...
with h5py.File('/das/work/p13/p13657/sandbox_viktor_goran/data/R108dC03a_S08_001_withAngles.h5','r') as fid:
    proj = fid['exchange/data'][:]
    flat = fid['exchange/data_white_pre'][:]
    dark = fid['exchange/data_dark'][:]
    theta = (fid['exchange/theta'][:]/180*np.pi).astype('float32')# note work with float32 angles only
...
tifffile.imwrite('/das/work/p13/p13657/sandbox_viktor_goran/data/R108dC03a_S08_001_withAngles.tif',res[2][(end+st)//2].astype('float32'))
